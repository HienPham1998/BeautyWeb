            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header rounded card-header-primary">
                     <h3 class="card-title text-white"> Manage Providers</h3>
                        
                        
                    </div>
                    <div class="card-body">
                    <a class="btn btn-primary btn-round" href="providers/create">
                            Add Provider
                        </a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($providers as $key => $provider)
                                    <tr>
                                        <td>
                                            {{ (($providers->currentPage() - 1 ) * $providers->perPage()) + ($key+1) }}
                                        </td>
                                        <td>
                                            {{ $provider->name }}
                                        </td> 
                                        ...
                                        <td> 
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-primary btn-link btn-sm px-2 btn-edit"
                                                        data-href="providers/update/{{ $provider->id }}"><i class="material-icons">edit</i></button>
                                                <button type="button" class="btn btn-danger btn-link btn-sm px-2" data-toggle="modal"
                                                        data-target="#modalDelete{{$provider->id}}"><i class="material-icons">close</i></button>

                                                <!-- Modal -->
                                                <div id="modalDelete{{$provider->id}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="providers/destroy/{{ $provider->id }}"
                                                                      method="post">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Update Provider</h5>
                    </div>
                    <div class="modal-body">
